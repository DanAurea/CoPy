...
class C99Lexer(object):
    ...
    reserved = {
                    ...
                    "int" : "INT", "inline" : "INLINE", "long" : "LONG", "register" : "REGISTER",
                    ...
                    "volatile" : "VOLATILE", "while" : "WHILE", "_Bool": "BOOLEAN", "_Complex": "COMPLEX",
    ...
    tokens = list(reserved.values()) + \
            [
                "TYPEDEF_NAME", "IDENTIFIER", "CONSTANT", "STRING_LITERAL",
                ...
                "RIGHT_OP", "INC_OP", "DEC_OP", "PTR_OP", "AND_OP",
